...
static void apiServerZones(HttpRequest* req, HttpResponse* resp) {
  ...
  if (req->method == "POST") {
    ...
    if (!nameservers.is_null() && !nameservers.is_array() && zonekind != DomainInfo::Slave && zonekind != DomainInfo::CatalogSlave)
    ...
    if (!have_soa && zonekind != DomainInfo::Slave && zonekind != DomainInfo::CatalogSlave) {
